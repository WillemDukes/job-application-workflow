...
This project handles job-seeker personal data. `profile.json`, `profile_private.json`, `screening_answers.json`, `employers.json`, `targets.csv`, `applied.jsonl`, `resumes/`, `documents/` and `logs/` are gitignored, and CI fails if any of them is committed. A pull request that commits real personal data will be closed and the author asked to rotate any exposed credentials.
...
> **See also:** [CONTRIBUTING.md](CONTRIBUTING.md) | [docs/AI-SECURITY.md](docs/AI-SECURITY.md) | [docs/FORK-SECURITY.md](docs/FORK-SECURITY.md)
